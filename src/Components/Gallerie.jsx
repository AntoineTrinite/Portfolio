      ...
      <div className="project-divider">
        <div className="description-part">
          ...
          <div className={`card ${activeCard === 0 ? 'active' : ''}`}>
            ...
            <div className="description">
              ...
              <div className="link-access">
                <a className='link-site' href="https://github.com/AntoineTrinite/Kasa" target="_blank">Code Github</a>
                <a className='link-site' href="https://github.com/AntoineTrinite/Kasa" target="_blank">Accéder au site</a>
              </div>
            </div>
          </div>
          ...
          <div className={`card ${activeCard === 1 ? 'active' : ''}`}>
            ...
            <div className="description">
              ...
              <div className="link-access">
                <a className='link-site' href="https://github.com/AntoineTrinite/P9-Groupomania" target="_blank">Code Github</a>
                <a className='link-site' href="https://github.com/AntoineTrinite/P9-Groupomania" target="_blank">Accéder au site</a>
              </div>
            </div>
          </div>
          ...
          <div className={`card ${activeCard === 2 ? 'active' : ''}`}>
            ...
            <div className="description">
              ...
              <div className="link-access">
                <a className='link-site' href="https://github.com/AntoineTrinite/P5-nina-carducci" target="_blank">Code Github</a>
                <a className='link-site' href="https://antoinetrinite.github.io/P5-nina-carducci/" target="_blank">Accéder au site</a>
              </div>
            </div>
          </div>
          ...
          <div className={`card ${activeCard === 3 ? 'active' : ''}`}>
            ...
            <div className="description">
              ...
              <div className="link-access">
                <a className='link-site' href="https://github.com/AntoineTrinite/P7-Mon-Vieux-Grimoire" target="_blank">Code Github</a>
                <a className='link-site' href="https://github.com/AntoineTrinite/P7-Mon-Vieux-Grimoire" target="_blank">Accéder au site</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="gallery-part">
          <div className={`site-card ${activeCard === 0 ? 'active' : ''}`}>
            ...
            <a href="https://github.com/AntoineTrinite/Kasa" target="_blank"><img className='site-img' src={kasa} alt="kasa website" /></a>
            
          </div>
          <div className={`site-card ${activeCard === 1 ? 'active' : ''}`}>
            <span className='site-title'>Groupomania</span>
            <a href="https://github.com/AntoineTrinite/P9-Groupomania" target="_blank"><img className='site-img' src={groupomania} alt="groupomania website" /></a>
            
          </div>
          <div className={`site-card ${activeCard === 2 ? 'active' : ''}`}>
            <span className='site-title'>Nina Carducci</span>
            <a href="https://antoinetrinite.github.io/P5-nina-carducci/" target="_blank"><img className='site-img' src={nina} alt="nina carducci website" /></a>
            
          </div>
          <div className={`site-card ${activeCard === 3 ? 'active' : ''}`}>
            <span className='site-title'>Mon Vieux Grimoire</span>
            <a href="https://github.com/AntoineTrinite/P7-Mon-Vieux-Grimoire" target="_blank"><img className='site-img' src={mvg} alt="Mon Vieux Grimoire site" /></a>
