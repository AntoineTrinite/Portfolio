                ...
                <div className="separator">
                    <div className="pres-sep">
                        ...
                        <div className="btn-group">
                            <a href="https://github.com/AntoineTrinite"  target="_blank"><button className='btn-rs'><i className="fa-brands fa-github"></i> Github</button></a>
                            <a href="https://www.linkedin.com/in/antoine-trinit%C3%A9-8a27a1159/"  target="_blank"><button className='btn-rs'><i className="fa-brands fa-linkedin"></i> Linkedin</button></a>
